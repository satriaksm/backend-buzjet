...
<main class="w-full">
    <h1 class="font-bold text-3xl">Buat Transportasi</h1>
                <div class="bg-white shadow-sm rounded-xl mt-4">
                        <form action="{{ route('transportations.store') }}" method="POST" enctype="multipart/form-data" class="">
                            <div class="grid grid-cols-6 ">
                                ...
                                <div class="px-5 pt-5 col-span-6">
                                    ...
                                    <input type="text" class="w-full border-gray-400 rounded @error('title') is-invalid @enderror" name="type" id="type" value="" placeholder="Masukkan Nama Destinasi">
                                ...
                                <div class="px-5 pt-5 col-span-6">
                                    ...
                                    <input type="text" class="w-full border-gray-400 rounded @error('title') is-invalid @enderror" name="company" id="company" value="" placeholder="Masukkan Nama Destinasi">
