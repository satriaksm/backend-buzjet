...
@section('content')
<main class="w-full">
    <h1 class="font-bold text-3xl">Buat Hotel</h1>
                <div class="bg-white shadow-sm rounded-xl mt-4">
                        <form action="{{ route('hotels.store') }}" method="POST" enctype="multipart/form-data" class="">
                            <div class="grid grid-cols-6 ">
                                ...
                                <div class="px-5 pt-5 col-span-6">
                                    ...
                                    <textarea class="w-full border-gray-400 rounded @error('description') is-invalid @enderror" name="description" id="description" rows="5" placeholder="Masukkan Description Destinasi">{{ old('description') }}</textarea>
